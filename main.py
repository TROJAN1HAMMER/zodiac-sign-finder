...
def main():
    ...
    birth_date = int(input("What is your birth date(00):"))
    birth_month1 = (input("What is the month of your birth:"))
    birth_month = birth_month1.lower()

    # To confirm

    print("Since your birth month is:", birth_month)
    print("And your birth date is:", birth_date)
    a1 = input("Is the given informations correct?")
    a_1 = ["no", "No", "nO"]

    if a1 in a_1:
        main()
    else:
        # For defying zodiac signs in different months
